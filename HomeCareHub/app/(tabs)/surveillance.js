...
export default function Surveillance() {
  ...
  const handleDoor = () => {
    ...
    Alert.alert(
      doorOpen ? '🔒 Porte verrouillée' : '🔓 Porte ouverte',
      doorOpen ? 'La serrure connectée a été verrouillée.' : 'La serrure connectée a été déverrouillée.'
    );
  };
      ...
      >
        ...
        <View style={styles.liveCard}>
          ...
          <View style={styles.camControls}>
            ...
            >
              ...
              <Text style={[styles.camCtrlLabel, recording && { color: '#F87171' }]}>
        ...
        <View style={styles.doorCard}>
          <TouchableOpacity
            ...
            onPress={() => { setDoorOpen(true); Alert.alert('🔓 Porte ouverte', 'Serrure déverrouillée à distance.'); }}
          >
            <Text style={styles.doorBtnIcon}>🔓</Text>
            <Text style={[styles.doorBtnText, { color: '#4ADE80' }]}>Ouvrir</Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={[styles.doorBtn, styles.doorBtnLock]}
            onPress={() => { setDoorOpen(false); Alert.alert('🔒 Porte verrouillée', 'Serrure verrouillée à distance.'); }}
          >
            <Text style={styles.doorBtnIcon}>🔒</Text>
            <Text style={[styles.doorBtnText, { color: '#F87171' }]}>Verrouiller</Text>
          </TouchableOpacity>
        </View>
