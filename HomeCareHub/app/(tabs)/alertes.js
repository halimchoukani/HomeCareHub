...
const MOCK_ALERTS = [
  {
    ...
    type: 'critique',
    icon: '⚠️',
    title: 'Visiteur suspect détecté',
    desc: 'Personne inconnue à l\'entrée principale',
    time: 'Il y a 5 min',
    date: "Aujourd'hui",
    lu: false,
  },
  {
    ...
    desc: 'Dr. Paul Renard a accédé au domicile',
    time: 'Il y a 2h',
    date: "Aujourd'hui",
    lu: false,
  },
  {
    ...
    desc: 'Badge inconnu utilisé à la porte',
    time: 'Il y a 3h',
    date: "Aujourd'hui",
    lu: true,
  },
  {
    ...
    type: 'medical',
    icon: '🏥',
    title: 'Caméra médicale activée',
    desc: 'Activée par infirmière Sophie Laurent',
    time: '14:05',
    date: 'Hier',
    lu: true,
  },
  {
    ...
    desc: 'Détection mouvement zone extérieure',
    time: '23:12',
    date: 'Hier',
    lu: true,
  },
  {
    ...
    desc: 'Serrure connectée verrouillée à distance',
    time: '20:30',
    date: 'Hier',
    lu: true,
  },
  ...
  },
  {
    ...
    desc: 'Accès prioritaire accordé aux secours',
    time: '08:45',
    date: '18 Mars',
    lu: true,
  },
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.statsRow}>
        ...
        <View style={styles.statBox}>
          <Text style={[styles.statValue, { color: '#F87171' }]}>{critiques}</Text>
          <Text style={styles.statLabel}>CRITIQUES</Text>
        </View>
        <View style={styles.statDivider} />
        <View style={styles.statBox}>
          <Text style={[styles.statValue, { color: '#FACC15' }]}>{nonLus}</Text>
      ...
      <View style={styles.actionsRow}>
        ...
        <TouchableOpacity style={[styles.actionBtn, styles.actionBtnDanger]} onPress={clearAll}>
          <Text style={[styles.actionBtnText, { color: '#F87171' }]}>🗑️ Effacer tout</Text>
        </TouchableOpacity>
      </View>
